    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        try {
          ...
          const res = await updateFarmerLocation({
            latitude,
            longitude,
          });
        ...
        >
          ...
          <CardFooter className="border-t flex flex-col gap-2 bg-gradient-to-r from-green-100 z-0 to-green-50 dark:from-green-900 dark:to-green-800 py-4">
            ...
            {farmer.latitude && farmer.longitude ? (
              ...
              <div className="w-full h-64 flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-lg border border-gray-300 dark:border-gray-700 px-2 text-center">
                <p className="text-gray-500">{td("notify")}</p>
              </div>
            )}
          </CardFooter>
        </Card>

...
// This is the farmer registration form that supports both registration and editing of farmer profiles. It also includes an option to autofill the form with data from the user's Clerk account.
"use client";

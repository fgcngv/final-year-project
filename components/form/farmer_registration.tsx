...
//// if the following code is already implemented, please ignore the above code and do not suggest it again. This is the updated version of the farmer registration form that supports both registration and editing of farmer profiles. It also includes an option to autofill the form with data from the user's Clerk account.
"use client";
...
import { FarmerRegistrationSchema } from "@/lib/schema";
import { registerFarmer, updateFarmer } from "@/app/[locale]/actions/general";
import { toast } from "sonner";
import { Language, Role, Status } from "@prisma/client";
import Header from "../header";
import { updateClerk } from "@/app/[locale]/actions/updateClerkMD";
...
export default function FarmerRegistrationForm({
  ...
  return (
    <div className={isEdit ? "p-4" : "min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50"}>
      <Header />

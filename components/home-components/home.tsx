        ...
        
        {
          !user && (
            ...
            <motion.button
                  ...
                  whileHover={{ scale: 1.08 }}
                  whileTap={{ scale: 0.97 }}
                  className=" cursor-pointer mt-10 px-8  bg-green- hover:bg-green-800/80 active:hover:bg-green-800/80 text-white font-semibold rounded-xl shadow-xl backdrop-blur-md flex items-center gap-2"
            >
              About Us
            </motion.button>
            <motion.button
                  ...
                  whileHover={{ scale: 1.08 }}
                  whileTap={{ scale: 0.97 }}
                  className=" cursor-pointer mt-10 px-8 py-4 hover:bg-green-800/80 active:hover:bg-green-800/80 text-white font-semibold rounded-xl shadow-xl backdrop-blur-md flex items-center gap-2"
            >
              Contact Us
            </motion.button>
          </motion.div>
